...
public class AndSignal implements ISourceSignal {
    ...
    public AndSignal(String sourceWire1, String sourceWire2, String wireName) {
    ...
    public AndSignal(String sourceWire1, Short sourceValue1, String wireName) {
        this.sourceWire1 = sourceWire1;
    ...
    public AndSignal(Short sourceValue1, Short sourceValue2, String wireName) {
