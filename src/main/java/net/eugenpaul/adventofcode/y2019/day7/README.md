...
The Elves have sent you some **Amplifier Controller Software** (your puzzle input), a program that should run on your [existing Intcode computer](../day5/README.md). Each amplifier will need to run a copy of the program.
